...
<div class="container">
    ...
    <div class="row mx-auto">
        ...
        <div class="col-md-6 text-justify mt-2">
            <p>S’ensuivront une ou plusieurs séances, vous ne ferez rien que vous n’auriez pas envie de faire, loin de
                ...
                séance.
                Je vous accompagnerai grâce au son de ma voix, à mes mots et à de la musique.
            </p><br>
    ...
    <p class="text-justify mt-4">L’état hypnotique garantit l’efficacité du soin et la mise en place du nouveau
        comportement. Ce
        n’est pas
        de
